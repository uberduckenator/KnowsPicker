			...
			if($user !=null && password_verify($_POST["password"], $user->password_hash)){
				...
				switch ($_SESSION['role']) {
					case 'company':
						...
						$_SESSION['company_id'] = $company->getCompany($_SESSION['login_id'])->company_id;
						break;

					case 'admin':
						$admin = $this->model('AdminProfile');
						$_SESSION['admin_id'] = $admin->getAdmin($_SESSION['login_id'])->admin_id;
						break;
