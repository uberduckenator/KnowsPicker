	...
	<?php
		...
		$wattage = $typeDetails->wattage;
			...
			echo "	<div class='form-group'>
					...
					<input type='text' class='form-control' name='chipset' id='chipset' value=$chipset readonly> 
					</div>";

			echo "	<div class='form-group'>
					<label for='username'>Memory</label>
					<input type='text' class='form-control' name='memory' id='memory' value=$memory readonly> 
					</div>";

			echo "	<div class='form-group'>
					<label for='username'>Memory Type</label>
					<input type='text' class='form-control' name='memory_type' id='memory_type' value=$memory_type readonly> 
					</div>";

			echo "	<div class='form-group'>
					<label for='username'>Core Clock</label>
					<input type='text' class='form-control' name='core_clock' id='core_clock' value=$core_clock readonly> 
					</div>";
			...
			echo "	<div class='form-group'>
					...
					<input type='text' class='form-control' name='length' id='length' value=$length readonly> 
					</div>";
