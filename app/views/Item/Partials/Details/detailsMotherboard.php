	...
	<?php
		...
		$wifi = $typeDetails->wifi;
			...
			echo "	<div class='form-group'>
					...
					<input type='text' class='form-control' name='ram_slots' id='ram_slots' value=$ram_slots readonly> 
					</div>";

			echo "	<div class='form-group'>
					<label for='username'>Max RAM</label>
					<input type='text' class='form-control' name='max_ram' id='max_ram' value=$max_ram readonly> 
					</div>";

			echo "	<div class='form-group'>
					<label for='username'>Memory Speed</label>
					<input type='text' class='form-control' name='memory_speed' id='memory_speed' value=$memory_speed readonly> 
					</div>";

			echo "	<div class='form-group'>
					<label for='username'>PCI E Slots</label>
					<input type='text' class='form-control' name='pci_e_slots' id='pci_e_slots' value=$pci_e_slots readonly> 
					</div>";

			echo "	<div class='form-group'>
					<label for='username'>Onboard Ethernet</label>
					<input type='text' class='form-control' name='onboard_ethernet' id='onboard_ethernet' value=$onboard_ethernet readonly> 
					</div>";

			echo "	<div class='form-group'>
					<label for='username'>SATA Ports</label>
					<input type='text' class='form-control' name='sata_ports' id='sata_ports' value=$sata_ports readonly> 
					</div>";

			echo "	<div class='form-group'>
					<label for='username'>M2 Slots</label>
					<input type='text' class='form-control' name='m2_slots' id='m2_slots' value=$m2_slots readonly> 
					</div>";

			echo "	<div class='form-group'>
					<label for='username'>Wifi</label>
					<input type='text' class='form-control' name='wifi' id='wifi' value=$wifi readonly> 
					</div>";
