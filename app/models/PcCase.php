...
class PcCase extends Model
{
	...
	{
		$stmt = self::$_connection->prepare("UPDATE pc_case SET type = :type, power_supply = :power_supply, mb_form_factor = :mb_form_factor, max_gpu_length = :max_gpu_length, internal_2_5_bays = :internal_2_5_bays, internal_3_5_bays = :internal_3_5_bays
